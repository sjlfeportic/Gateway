...
public class LivePRhistory extends AppCompatActivity {

    Button insertButton;
    GraphView graphView;

    DatabaseHandler1 dbh;
    ...
    public void insertData()
    {
        insertButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                TextView prValue = ConnectFragment.ok1;
                String value = prValue.getText().toString();
